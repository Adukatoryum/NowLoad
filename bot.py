...
# Маршруты па ўзросту — толькі для раздзелаў, дзе няма ўваходнага экрана з выбарам шляху
# can_i_work тут не ўваходзіць: у яго ёсць свой экран «інфа або гульня» перад узростам
AGE_ROUTE = {
    "earn_start": {
